...
export default class RideCancelBill extends Component
{
    constructor(props) {
        super(props);
        this.state = {
  ...
  render() {
    ...
    <View style={{flex:1,backgroundColor:'#165686'}}>
        ...
        <View style={{flexDirection:'row',marginTop:hp('7%'),justifyContent:'center'}}>
            ...
            <Image source={require('./wrong.png')}
                style={{alignSelf:'center',width: wp('8%'),height:wp('8%'),marginRight:wp('7%')}}/>
            <Text style={{ alignSelf:'center',fontSize:wp('6%'),color:'#fff',fontWeight:'bold'}}>Trip Cancelled</Text>
            </View>
        </View>
...
AppRegistry.registerComponent('RideCancelBill', () => lottieloader);